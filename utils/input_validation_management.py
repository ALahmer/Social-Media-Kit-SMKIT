...
def process_input(input_path, module, args_base_directory=None, args_base_url=None):
    ...
    if os.path.isfile(input_path):
        return process_file(input_path, base_dir, base_url)

    if os.path.isdir(input_path):
        print(f"Processing directory: {input_path}")
        return process_directory(input_path, base_dir, base_url)
...
def process_file(input_path, base_dir, base_url):
    """
...
def process_directory(directory_path, base_dir, base_url):
    """
    ...
    for root, _, files in os.walk(directory_path):
        for filename in files:
            ...
            web_urls.extend(process_file(filepath, base_dir, base_url))
    return web_urls
